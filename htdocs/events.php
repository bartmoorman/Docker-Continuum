...
<html lang='en'>
  <head>
    <title><?php echo $continuum->appName ?> - Events</title>
    <meta charset='utf-8'>
...
foreach ($continuum->getEvents($currentPage) as $event) {
...
<?php
$pages = ceil($continuum->getObjectCount('events') / $continuum->pageLimit);
